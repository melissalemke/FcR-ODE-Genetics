...
g1tot    = 8.54195E-05*10^6;%mM These are the averages from all patients
g2tot    = 1.32837E-07*10^6;%mM 
g3tot    = 3.06998E-06*10^6;%mM 
g4tot    = 1.02194E-07*10^6;%mM 
etot    = 2.5e-5*10^6;%mM 
ftot    = 2e-5*10^6;%mM 
...
file_to_load = 'ps_'+fcr_ttl+'.mat';
 save(file_to_load,'params', 'paramnames', 'complexes','fcr_ttl','fcr_names');
end